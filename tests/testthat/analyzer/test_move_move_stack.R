...
test_data <- readRDS(file = "tests/testthat/data/move_move_stack/input2_geese.rds")
...
test_that("null-result", {
  actual <- analyzeMoveMoveStack(NULL)
...
test_that("one-item-result", {
  actual <- analyzeMoveMoveStack(rds = readRDS(file = "tests/testthat/data/move_move_stack/N1.rds")) 
