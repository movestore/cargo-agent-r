source("../../src/analyzer/move2_move2_loc/move2_move2_loc.R")
library(testthat)

test_data <- readRDS(file = test_path("data", "move2_move2_loc", "input2_move2_whitefgeese.rds"))
...
test_that("null-result", {
  actual <- analyzeMove2Move2_loc(readRDS(file = test_path("data", "move2_move2_loc", "input0_move2_null.rds")))
