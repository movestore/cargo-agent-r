      ...
      if (nrow(rds) == 0) # no locations is possible
        {
          ...
          root <- mapMove2Move2_nonlocOutput(
            n = "empty-result",
            sensor_types = NA,
            timestamps_range = rep(NA, 2),
            events_total_number = 0,
        ...
        root <- mapMove2Move2_nonlocOutput(
          ...
          events_total_number = nrow(rds), # maybe this is better named total number of events
          ...
          track_names = ids,
          number_events_by_track = data.frame("animal" = names(id_posis), "events_number" = id_posis),
...
mapMove2Move2_nonlocOutput <- function(
    n,
    sensor_types = NA,
    timestamps_range = NA,
    events_total_number = NA,
  ...
  list(
    ...
    events_total_number = events_total_number,
    ...
    number_events_by_track = number_events_by_track,
